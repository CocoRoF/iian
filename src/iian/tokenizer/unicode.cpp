// Derived from llama.cpp (src/unicode.cpp) - MIT License, see THIRD_PARTY_NOTICES.md.
...
[[maybe_unused]] static std::string unicode_cpts_to_utf8(const std::vector<uint32_t> & cps) {
    std::string result;
