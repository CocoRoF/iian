...
inline std::string peak_source(const std::string & source, size_t pos, size_t max_peak_chars = 40) {
    if (source.empty()) {
...
inline std::string fmt_error_with_source(const std::string & tag, const std::string & msg, const std::string & source, size_t pos) {
