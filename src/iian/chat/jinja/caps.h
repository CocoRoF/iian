...
struct caps {
    ...
    // iian extensions (not present in llama.cpp's jinja::caps):
    // template renders the content of role:"tool" messages
    bool supports_tool_responses = false;
    // template references the enable_thinking variable
